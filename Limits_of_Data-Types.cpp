...
int main()
{
    ...
    cout << " The Maximum limits of char " << numeric_limits<char>::max();
    cout << " The Minimum limits of char " << numeric_limits<char>::min();

    cout << " The Maximum limits of float " << numeric_limits<float>::max();
    cout << " The Minimum limits of float " << numeric_limits<float>::min();

    cout << " The Maximum limits of double " << numeric_limits<double>::max();
    cout << " The Minimum limits of double " << numeric_limits<double>::min();

    cout << " The Maximum limits of long " << numeric_limits<long>::max();
    cout << " The Minimum limits of long " << numeric_limits<long>::min();
}
